%% This script uses all the metric tricks described in 
%% Eq. 3.12 of my thesis, using coordinate radius as the 
%% radial parameter.  Areal radius, however, is used to 
%% correct the meaning of r in rMPsi4.
...
l=1;
for r=R;
    Temp = Waveform(sprintf(WaveformName,r), 'ReIm', r);
    Temp = Temp(1);
    Temp.Type = 'rMPsi4';
    ...
    %Temp = Scale(Temp, ArealRadius/r, 'Amp');
    ...
    Ws{l} = Offset('Tortoise', Scale(Temp, IRRMass/ADMMass), ADMMass);
    if(l>1);
