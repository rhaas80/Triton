...
WaveformUtilities::WaveformAmplitudesSumMMagSquared::WaveformAmplitudesSumMMagSquared(const WaveformUtilities::WaveformAmplitudes& WA)
  : NormalizationFactor(WA.NormalizationFactor*WA.NormalizationFactor),
    ...
    Sum_v7(4.*(WA.Hhat_L2_M1_Im_v3*WA.Hhat_L2_M1_Im_v4 + WA.Hhat_L2_M1_Im_v2*WA.Hhat_L2_M1_Im_v5 + WA.Hhat_L2_M1_Im_v1*WA.Hhat_L2_M1_Im_v6 + 4.*WA.Hhat_L2_M2_Re_v3*WA.Hhat_L2_M2_Re_v4 + 4.*WA.Hhat_L2_M2_Re_v2*WA.Hhat_L2_M2_Re_v5 + WA.Hhat_L3_M1_Im_v3*WA.Hhat_L3_M1_Im_v4 + WA.Hhat_L3_M1_Im_v1*WA.Hhat_L3_M1_Im_v6 + 4.*WA.Hhat_L3_M2_Re_v3*WA.Hhat_L3_M2_Re_v4 + 4.*WA.Hhat_L3_M2_Re_v2*WA.Hhat_L3_M2_Re_v5 + 9.*WA.Hhat_L3_M3_Im_v3*WA.Hhat_L3_M3_Im_v4 + 9.*WA.Hhat_L3_M3_Im_v1*WA.Hhat_L3_M3_Im_v6 + 4.*WA.Hhat_L4_M2_Re_v2*WA.Hhat_L4_M2_Re_v5 + 16.*WA.Hhat_L4_M4_Re_v2*WA.Hhat_L4_M4_Re_v5)),
    ...
    Sum_v12(2.*pow(WA.Hhat_L2_M1_Re_v6,2) + 2.*pow(WA.Hhat_L2_M1_Im_v6,2) + 8.*pow(WA.Hhat_L2_M2_Re_v6,2) + 8.*pow(WA.Hhat_L2_M2_Im_v6,2) + 2.*pow(WA.Hhat_L3_M1_Re_v6,2) + 2.*pow(WA.Hhat_L3_M1_Im_v6,2) + 8.*pow(WA.Hhat_L3_M2_Re_v6,2) + 18.*pow(WA.Hhat_L3_M3_Re_v6,2) + 18.*pow(WA.Hhat_L3_M3_Im_v6,2) + 2.*pow(WA.Hhat_L4_M1_Re_v6,2) + 2.*pow(WA.Hhat_L4_M1_Im_v6,2) + 8.*pow(WA.Hhat_L4_M2_Re_v6,2) + 18.*pow(WA.Hhat_L4_M3_Re_v6,2) + 18.*pow(WA.Hhat_L4_M3_Im_v6,2) + 32.*pow(WA.Hhat_L4_M4_Re_v6,2) + 2.*pow(WA.Hhat_L5_M1_Re_v6,2) + 2.*pow(WA.Hhat_L5_M1_Im_v6,2) + 8.*pow(WA.Hhat_L5_M2_Re_v6,2) + 18.*pow(WA.Hhat_L5_M3_Re_v6,2) + 18.*pow(WA.Hhat_L5_M3_Im_v6,2) + 32.*pow(WA.Hhat_L5_M4_Re_v6,2) + 50.*pow(WA.Hhat_L5_M5_Re_v6,2) + 50.*pow(WA.Hhat_L5_M5_Im_v6,2) + 8.*pow(WA.Hhat_L6_M2_Re_v6,2) + 32.*pow(WA.Hhat_L6_M4_Re_v6,2) + 72.*pow(WA.Hhat_L6_M6_Re_v6,2) + 8.*pow(WA.Hhat_L7_M2_Re_v6,2) + 32.*pow(WA.Hhat_L7_M4_Re_v6,2) + 72.*pow(WA.Hhat_L7_M6_Re_v6,2) + 8.*pow(WA.Hhat_L8_M2_Re_v6,2) + 32.*pow(WA.Hhat_L8_M4_Re_v6,2) + 72.*pow(WA.Hhat_L8_M6_Re_v6,2) + 128.*pow(WA.Hhat_L8_M8_Re_v6,2)),
    Sum_v12lnv(16.*WA.Hhat_L2_M2_Re_v6*WA.Hhat_L2_M2_Re_v6lnv),
    Sum_v12lnv2(8.*pow(WA.Hhat_L2_M2_Re_v6lnv,2))
{ }
