% Wo = W1+W2
% 
%  This function simply adds the amplitude data and phase
%  data from two different Waveform objects.  The data are
%  interpolated to the largest, finest common time grid

function Wo = plus(W1, W2)
    Wo = W1;
...
%     if(MaxTime > W2.Time(end)); MaxTime = W2.Time(end); end;
    ...
    Wo.PostProcessing = ...
        [Wo.PostProcessing; ...
         {sprintf('this = plus(%s, %s);', W1.Identifier, ...
                  W2.Identifier)}; ...
