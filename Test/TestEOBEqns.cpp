...
EOBRightHandSide::EOBRightHandSide(const double idelta, const double ichis, const double ichia, const double PNPhaseOrder)
  : delta(idelta), nu((1.0-delta*delta)/4.0), chis(ichis), chia(ichia), PNOrder(PNPhaseOrder),
    ...
    f7((3416878080.0*EulerGamma - 3*(6643739519.0 + 372556800*pow(M_PI,2)) + 1925*(2*nu*(941801 + 6*nu*(283209 + 21700*nu) - 46494*pow(M_PI,2)) + 45*(-78168 + nu*(300643 + 154708*nu))*M_PI*vPole) + 1708439040.0*log(16*pow(vLSO,2)))/(2.095632e8*vPole)),
