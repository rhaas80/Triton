...
f0 = 100 #Hz, frequency to start the computation
v0 = (0.95*f0*Scale()*totalmass*math.pi)**(1./3.) #Start waves a bit sooner for windowing

# Load the NR data

NSNS  = []
NSNS.append(PyGW.Waveform("/home/kbarkett/Caltech/WaveData/q1_NSNS/cce_integrated/Hy1Gr1_CceR2090/y_l2_m2.dat", 'ReIm'))
NSNS.append(PyGW.Waveform("/home/kbarkett/Caltech/WaveData/q1_NSNS/cce_integrated/Hy2Gr2_CceR2090/y_l2_m2.dat", 'ReIm'))
NSNS.append(PyGW.Waveform("/home/kbarkett/Caltech/WaveData/q1_NSNS/cce_integrated/Hy3Gr3_CceR2090/y_l2_m2.dat", 'ReIm'))

BBH   = PyGW.Waveform("/home/kbarkett/Caltech/Scripts/NSNS_Tidal_Scripts/BBH/rhOverM_Extrapolated_N3.dat", 'MagArg')
BBH   = BBH[4]
...
LIGO = np.loadtxt("/home/kbarkett/Caltech/Scripts/ZERO_DET_high_P.txt")
LIGOfreq = LIGO[:,0]
LIGOsig  = LIGO[:,1]
