...
the 'Extrapolate' class in 'Triton/PyGW/Extrapolate_h5.py' by running
  import PyGW.Extrapolate_h5
  help(PyGW.Extrapolate_h5.Extrapolate)
from within python.

To extrapolate non-H5 files, see the similar file named
'Triton/Examples/ExtrapolationExample.py'.
