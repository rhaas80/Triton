...
vector<string>& split(const string& s, vector<string>& elems, char delim) {
    stringstream ss(s);
    string item;
...
vector<string> split(const string &s, char delim) {
    vector<string> elems;
    return split(s, elems, delim);
}

string TrimWhiteSpace(const string& String) {
...
string StripComments(const string& String, const char CommentChar) {
...
void SplitStringToKeysAndValues(const string& String, vector<string>& Keys, vector<string>& Values) {
  string Uncommented = StripComments(String);
  vector<string> Pairs = split(Uncommented);
...
double StringToDouble(const string& String) {
  double Double;
  stringstream ss(String);
  ss >> Double;
  return Double;
...
vector<int> StringToVectorInt(const string& String) {
  int Int;
...
vector<double> StringToVectorDouble(const string& String) {
  double Double;
...
vector<string> StringToVectorString(const string& String) {
  return split(String, ' ');
}



string DoubleToString(const double x, const unsigned int Width) {
