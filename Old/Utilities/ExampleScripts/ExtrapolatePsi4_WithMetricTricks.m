...
%% Eq. 3.12 of my thesis, using areal radius as the 
%% radial parameter (which I don't think is right).
%% Areal radius is also used to correct the meaning of
%% r in rMPsi4.
