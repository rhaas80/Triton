...
WaveformUtilities::Flux_Taylor::Flux_Taylor(const double delta, const double chis)
...
WaveformUtilities::Flux_Taylor8::Flux_Taylor8(const double delta, const double chis)
  : nu((1.0-delta*delta)/4.0),
    F0((32*std::pow(nu,2))/5.),
    F2((-1247 - 980*nu)/336.),
    F3(chis*(-2.75 + 3*nu) + 4*M_PI),
...
WaveformUtilities::Flux_Pade44LogConst::Flux_Pade44LogConst(const double delta, const double chis)
...
WaveformUtilities::Flux_Pade44LogFac::Flux_Pade44LogFac(const double delta, const double chis)
  : nu((1.0-delta*delta)/4.0), N((32*nu*nu)/5.),
...
WaveformUtilities::Flux_SumAmplitudes::Flux_SumAmplitudes(const double idelta, const double ichis)
