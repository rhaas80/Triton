...
public:
  T2(const double idelta, const double ichis, const double v0)
    : delta(idelta), nu((1.0-delta*delta)/4.0), chis(ichis), Phi0(0.0),
      ...
      t6(88.26007501566575 + 661.6641095351773*nu - 8.802662037037036*pow(nu,2) + 19.72608024691358*pow(nu,3) + chis*(-611.563369898813 + 469.1445029360757*nu) + pow(chis,2)*(10.186011904761903 - 258.4940476190476*nu + 81.66666666666666*pow(nu,2))),
      ...
      Phi6(-110.3250937695822 + chis*(764.4542123735164 - 586.4306286700947*nu) - 827.0801369189717*nu + 11.003327546296296*pow(nu,2) - 24.657600308641975*pow(nu,3) + pow(chis,2)*(-12.732514880952381 + 323.1175595238095*nu - 102.08333333333333*pow(nu,2))),
      Phi6Lnv(-81.52380952380952),
      Phi7(pow(chis,3)*(61.14955357142857 - (22075*nu)/672. + (835*pow(nu,2))/12.) + chis*(-839.1949561822221 + (4394668795*nu)/6.096384e6 + (11446555*pow(nu,2))/24192. - (71705*pow(nu,3))/864.) + (77096675*M_PI)/2.032128e6 + (378515*nu*M_PI)/12096. - (74045*pow(nu,2)*M_PI)/6048. + pow(chis,2)*((-285*M_PI)/4. + 5*nu*M_PI))
  {
    double t;
    (*this)(v0, t, Phi0);
    Phi0 *= -1.0;
