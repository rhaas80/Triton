                ...
                if kind == 'class' :
                    ...
                    for memberdef in memberdefs :
                        if (memberdef.attributes['kind'].value=='variable') :
                            ...
                            declaration = self.human_readable(memberdef.getElementsByTagName('type')[0]).replace('WaveformUtilities::','').replace('std::','') + ' ' \
                ...
                if ((memberdef.attributes['kind'].value=='function') and (memberdef.attributes['prot'].value=='public')) :
                    ...
                    if len(params)==0 :
                        ...
                        for param in params :
                            ...
                            docstring += '    ' + (type + ' ' + declname).replace('WaveformUtilities::','').replace('std::','')
                            default = param.getElementsByTagName('defval')
                            if len(default)>0 : docstring += ' = ' + self.human_readable(default[0]).replace('WaveformUtilities::','').replace('std::','')
                            docstring += '\n'
